...
const renderLayoutIntoContainer = (container, layout) => {
  container.insertAdjacentHTML(`beforeend`, layout);
};

renderLayoutIntoContainer(mainControl, `<section class="control__btn-wrap">
          <input
            type="radio"
            name="control"
...
renderLayoutIntoContainer(main, `<section class="main__search search container">
        <input
          type="text"
          id="search__input"
          class="search__input"
...
renderLayoutIntoContainer(main, `<section class="main__filter filter container">
        <input
          type="radio"
          id="filter__all"
